...
branch_11.add(Convolution2D(32, 1, 1, border_mode='same', input_shape=(28, 28, 1)))
branch_11.add(Activation("relu"))
branch_13 = Sequential()
branch_13.add(Convolution2D(32, 3, 3, border_mode='same', input_shape=(28, 28, 1)))
...
pre_merged1 = Merge([branch_11, branch_13, branch_15], mode='concat')
merged1 = Sequential()
merged1.add(pre_merged1)
merged1.add(MaxPooling2D(pool_size=(4, 4), border_mode='same'))

#Second inception module
branch_21 = Sequential()
branch_21.add(merged1)
branch_21.add(Convolution2D(218, 1, 1, border_mode='same', input_shape=(7, 7, 1)))
branch_21.add(Activation("relu"))
branch_23 = Sequential()
branch_23.add(merged1)
branch_23.add(Convolution2D(218, 3, 3, border_mode='same', input_shape=(7, 7, 1)))
branch_23.add(Activation("relu"))
branch_25 = Sequential()
branch_25.add(merged1)
branch_25.add(Convolution2D(218, 5, 5, border_mode='same', input_shape=(7, 7, 1)))
